...
CREATE TABLE `financial_flow`  (
  ...
  `trans_out_id` bigint NULL DEFAULT NULL COMMENT '出账者在支付平台id',
  `trans_in_id` bigint NULL DEFAULT NULL COMMENT '入账者在支付平台id',
  `trade_type` tinyint UNSIGNED NOT NULL COMMENT '0-充值 1-提现 2-订单支付 3-退款 4-平台佣金',
  `refund_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '退款号',
  `out_trade_no` bigint NOT NULL COMMENT '支付单号',
  `trade_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '回调单号',
  `order_id` bigint NULL DEFAULT NULL COMMENT '订单号-如果财务种类是订单',
  ...
  `update_time` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_id`(`buyer_id` ASC) USING BTREE
...
-- ----------------------------
INSERT INTO `merchant_supplement` VALUES (1, 1996953140859625474, 'ADMIN_SHOP', 1996954588037107713, 'WEBSIZE', '00X00X00X', '000x0x000x0x0x000x', 0, 0, 0, 0, '2025-12-09 21:25:36', '2025-12-24 00:29:58');
...
-- ----------------------------
INSERT INTO `order_address` VALUES (2003505105655685122, 2016380730346643457, 1996953140859625474, '布莱克凯特', '15626448742', '广东', '广州', '番禺', '广东工业大学', 0, '2026-01-28 13:20:03', '2026-01-28 13:20:03');
...
-- ----------------------------
INSERT INTO `order_main` VALUES (2016380728048164865, 1996953140859625474, 1996953140859625474, 2000808873962766337, 2003647779074756609, 2, 119.98, 119.98, '布莱克凯特是由石油提炼的吗?', '典藏款', '消费优惠券: []', 0, 0, 0, '2026-01-28 13:20:03', '2026-01-28 13:20:03');
...
-- ----------------------------
INSERT INTO `order_status_log` VALUES (2016380729176432642, 2016380728048164865, 1996953140859625474, '2026-01-28 13:20:03', '0', '订单待付款', 0, '2026-01-28 13:20:03', '2026-01-28 13:20:03');
...
INSERT INTO `product` VALUES (2000808873962766337, 2003647779074756609, 'ADMIN', '布莱克凯特是由石油提炼的吗?', 0, 48, 2000803576611430401, 0, 0, 'BlackCat!', 1996953140859625474, 0, 1, 0, '2025-12-16 14:03:03', '2026-01-28 13:20:03');
...
INSERT INTO `product_sku` VALUES (2003647779074756609, 2000808873962766337, '典藏款', 59.99, 0, 3, '', 0, 0, '2025-12-24 10:03:51', '2026-01-28 13:20:03');
