...
public class ProductController {
    ...
    public Result<Page<ProductProfileVO>> list(@Validated(SelectGroup.class) ProductListDTO productListDTO){
...
//- 注意无论商品是否被下架或逻辑删除都应该被被查到
    ...
    public Result<Page<ProductProfileVO>> feed(@Validated(SelectGroup.class) ProductFeedDTO productFeedDTO){
