...
//- 如果查询不到用户或用户被逻辑删除则拒绝分配
    ...
    public Result<Void> add(@Validated(AddGroup.class) @RequestBody RoleDTO roleDTO){
//        添加角色
    ...
    public Result<Void> update(@Validated(UpdateGroup.class) @RequestBody RoleDTO roleDTO){
//        更新角色信息,角色被逻辑删除则拒绝更新
